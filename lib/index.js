...
S3rver.prototype.run = function (alternateHandlers, done) {
  if (!done && alternateHandlers) {
    done = alternateHandlers;
    alternateHandlers = null;
  }
  var app = new App(this.options);
  if (alternateHandlers) {
    alternateHandlers(app)
  }
